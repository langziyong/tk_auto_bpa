...
class MainControl:
    ...
    def login(self,user):
       ...
       #直接进行获取
        ...
        self.log = self.log + "\n会话Cookie获取成功：" + str(self.sessionid_cookie)
        ...
        self.log = self.log + "\nSessionid获取成功：" + str(self.sessionid)
    ...
    def commit(self,user):
        ...
        #self.log = self.log + "\n提交数据为："+commit_body
        self.log = self.log + "\n提交数据太长了省略\n" + str(user)
        print("↓POST请求响应检查点↓  如果下面行为空说明提交失败！有 callback 字样表示成功")
        self.log = self.log + "\n↓↓↓↓↓↓↓↓↓↓POST请求响应检查点↓↓↓↓↓↓↓↓↓↓  如果下面行为空说明提交失败！有 callback 字样表示成功\n"
        print(requests.text)
        ...
        self.log = self.log + "\nSessionid_2获取成功  "'%s' % self.sessionid_2
